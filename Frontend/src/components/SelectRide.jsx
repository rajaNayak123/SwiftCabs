      ...
      <div className="flex gap-2 justify-between flex-col items-center">
            ...
            <div className="w-full mt-3">
                <div className="flex items-center gap-5 p-2 border-b-2">
                    <i class="text-2xl ri-map-pin-line"></i>
                     <div>
                        <h3 className="text-lg font-medium">596/E-4</h3>
                        <p className="text-sm -mt-1 text-gray-500">Blishapur, Starex University</p>
                     </div>
                </div>
                <div className="flex items-center gap-5 p-2 border-b-2">
                    <i class="text-2xl ri-map-pin-line"></i>
                ...
                <i class="text-2xl ri-money-rupee-circle-line"></i>
                     <div>
            ...
            <button className="w-full mt-3 bg-black text-white font-semibold p-2 rounded-lg">Conform</button>
      </div>
    </div>
  );
};
